...
* **Outputs**: 
    * GFA file: 'referenceGenome_gaps_noMin-noMax_contigs_noMinFlank.gfa'
    * FASTA files containing the left flanking region of the gap/target: 'referenceGenome_[scaffoldID]_[coordLeftFlankingSeq_start]-[coordLeftFlankingSeq_end].g[locusLength].cnoMinFlank.left.fasta'
    * FASTA files containing the right flanking region of the gap/target: 'referenceGenome_[scaffoldID]_[coordRightFlankingSeq_start]-[coordRightFlankingSeq_end].g[locusLength].cnoMinFlank.right.fasta'
...
* referenceGenome_gaps_noMin-noMax_contigs_noMinFlank.gfa: GFA file obtained from `bed2gfa.py`
...
../../utils/gfa2tofasta.py -in ./MTG-Link_results/referenceGenome_gaps_noMin-noMax_contigs_noMinFlank_mtglink.gfa -out .
```
* referenceGenome_gaps_noMin-noMax_contigs_noMinFlank_mtglink.gfa: GFA file output by ***MTG-Link***
* **Output**:
    * FASTA file: 'referenceGenome_gaps_noMin-noMax_contigs_noMinFlank_mtglink_assembly.fasta'
