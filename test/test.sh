...
if (awk '/\t\* 68_0-222132-L+:68_223132-445265-R+\n\t\t\* fwd\t2000 bp\tAA\n\t\t\* rev\t2000 bp\tAA\n\t\* 26939_0-464805-L+:26939_465805-930610-R+\n\t\t\* fwd\t2004 bp\tAA\n\t\t\* rev\t2004 bp\tAA/' LOGMTGLinkDBGRunInto) and (awk '/The gap 27292_0-183358-L+_27292_184358-367715-R+ was not successfully gap-filled/' LOGMTGLinkDBGRunInto)
then
...
if (awk '/\t\* 68_0-222132-L+:68_223132-445265-R+\n\t\t\* fwd\t1998 bp\tAB\n\t\* 26939_0-464805-L+:26939_465805-930610-R+\n\t\t\* fwd\t2014 bp\tAA/' LOGMTGLinkIRORunInto) and (awk '/The gap 27292_0-183358-L+_27292_184358-367715-R+ was not successfully gap-filled/' LOGMTGLinkIRORunInto)
then
...
if (awk '/\t\* 68_0-222132-L+:68_223132-445265-R+\n\t\t\* fwd\t2000 bp\tA\n\t\t\* rev\t2000 bp\tA\n\t\* 26939_0-464805-L+:26939_465805-930610-R+\n\t\t\* fwd\t2004 bp\tB\n\t\t\* rev\t2004 bp\tB/' LOGMTGLinkDBGRunIntoRef) and (awk '/The gap 27292_0-183358-L+_27292_184358-367715-R+ was not successfully gap-filled/' LOGMTGLinkDBGRunIntoRef)
then
...
if (awk '/\t\* 68_0-222132-L+:68_223132-445265-R+\n\t\t\* fwd\t1998 bp\tB\n\t\* 26939_0-464805-L+:26939_465805-930610-R+\n\t\t\* fwd\t2014 bp\tB/' LOGMTGLinkIRORunIntoRef) and (awk '/The gap 27292_0-183358-L+_27292_184358-367715-R+ was not successfully gap-filled/' LOGMTGLinkIRORunIntoRef)
then
...
if (awk '/\t\* 68-1+:68-2+\n\t\t\* fwd\t2000 bp\tAA\n\t\t\* rev\t2000 bp\tAA\n\t\* 26939-1+:26939-2+\n\t\t\* fwd\t2004 bp\tAA\n\t\t\* rev\t2004 bp\tAA/' LOGMTGLinkDBGRunBetween) and (awk '/The gap 27292-1+_27292-2+ was not successfully gap-filled/' LOGMTGLinkDBGRunBetween)
then
    echo "MTG-Link DBG w/o ref: Pass"
else
    echo "MTG-Link DBG w/o ref: Fail"
...
if (awk '/\t\* 68-1+:68-2+\n\t\t\* fwd\t1998 bp\tAB\n\t\* 26939-1+:26939-2+\n\t\t\* fwd\t2014 bp\tAA/' LOGMTGLinkIRORunBetween) and (awk '/The gap 27292-1+_27292-2+ was not successfully gap-filled/' LOGMTGLinkIRORunBetween)
then
    echo "MTG-Link IRO w/o ref: Pass"
else
    echo "MTG-Link IRO w/o ref: Fail"
...
if (awk '/\t\* 68-1+:68-2+\n\t\t\* fwd\t2000 bp\tA\n\t\t\* rev\t2000 bp\tA\n\t\* 26939-1+:26939-2+\n\t\t\* fwd\t2004 bp\tB\n\t\t\* rev\t2004 bp\tB/' LOGMTGLinkDBGRunBetweenRef) and (awk '/The gap 27292-1+_27292-2+ was not successfully gap-filled/' LOGMTGLinkDBGRunBetweenRef)
then
    echo "MTG-Link DBG w/ ref: Pass"
else
    echo "MTG-Link DBG w/ ref: Fail"
...
if (awk '/\t\* 68-1+:68-2+\n\t\t\* fwd\t1998 bp\tB\n\t\* 26939-1+:26939-2+\n\t\t\* fwd\t2014 bp\tB/' LOGMTGLinkIRORunBetweenRef) and (awk '/The gap 27292-1+_27292-2+ was not successfully gap-filled/' LOGMTGLinkIRORunBetweenRef)
then
    echo "MTG-Link IRO w/ ref: Pass"
else
    echo "MTG-Link IRO w/ ref: Fail"
