...
def getOutputForGfa(record, extSize, leftName, rightName, leftScaffold, rightScaffold, module, k):
    ...
    Return:
        - outputGFA: list
            list containing the assembled sequence's name, as well as its length, its sequence, the full solution name with the orientation sign, the k-mer size used for the DBG assembly, the beginning and ending positions of the overlap and the quality of the assembled sequence
    """
    try:
